...
namespace Sdcb.Mattermost.DotNetSdk.Test
{
    ...
    public class ClusterApiTests : IDisposable
    {
        ...
        public void InstanceTest()
        {
            ...
            //Assert.IsType(typeof(ClusterApi), instance, "instance is a ClusterApi");
        }
        ...
        public void ClusterStatusGetTest()
        {
            ...
            //var response = instance.ClusterStatusGet();
            //Assert.IsType<List<ClusterInfo>> (response, "response is List<ClusterInfo>");
        }
