...
namespace Sdcb.Mattermost.DotNetSdk.Model
{
    ...
    public partial class InlineObject19 :  IEquatable<InlineObject19>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="InlineObject19" /> class.
        /// </summary>
        /// <param name="tokenId">The personal access token GUID to enable (required).</param>
        public InlineObject19(string tokenId = default(string))
        {
            // to ensure "tokenId" is required (not null)
            if (tokenId == null)
            {
                throw new InvalidDataException("tokenId is a required property for InlineObject19 and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The personal access token GUID to enable</value>
