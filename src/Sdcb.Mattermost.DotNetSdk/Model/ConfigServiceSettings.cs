...
namespace Sdcb.Mattermost.DotNetSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ConfigServiceSettings :  IEquatable<ConfigServiceSettings>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigServiceSettings" /> class.
        /// </summary>
        ...
        public ConfigServiceSettings(string siteURL = default(string), string listenAddress = default(string), string connectionSecurity = default(string), string tLSCertFile = default(string), string tLSKeyFile = default(string), bool useLetsEncrypt = default(bool), string letsEncryptCertificateCacheFile = default(string), bool forward80To443 = default(bool), int readTimeout = default(int), int writeTimeout = default(int), int maximumLoginAttempts = default(int), string segmentDeveloperKey = default(string), string googleDeveloperKey = default(string), bool enableOAuthServiceProvider = default(bool), bool enableIncomingWebhooks = default(bool), bool enableOutgoingWebhooks = default(bool), bool enableCommands = default(bool), bool enableOnlyAdminIntegrations = default(bool), bool enablePostUsernameOverride = default(bool), bool enablePostIconOverride = default(bool), bool enableTesting = default(bool), bool enableDeveloper = default(bool), bool enableSecurityFixAlert = default(bool), bool enableInsecureOutgoingConnections = default(bool), bool enableMultifactorAuthentication = default(bool), bool enforceMultifactorAuthentication = default(bool), string allowCorsFrom = default(string), int sessionLengthWebInDays = default(int), int sessionLengthMobileInDays = default(int), int sessionLengthSSOInDays = default(int), int sessionCacheInMinutes = default(int), int websocketSecurePort = default(int), int websocketPort = default(int), string webserverMode = default(string), bool enableCustomEmoji = default(bool), string restrictCustomEmojiCreation = default(string))
        {
        ...
        {
            return this.Equals(input as ConfigServiceSettings);
        }

        /// <summary>
        /// Returns true if ConfigServiceSettings instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfigServiceSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfigServiceSettings input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    (this.LetsEncryptCertificateCacheFile != null &&
                ...
                (
                    ...
                    (this.RestrictCustomEmojiCreation != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LetsEncryptCertificateCacheFile != null)
                ...
                if (this.SegmentDeveloperKey != null)
                    hashCode = hashCode * 59 + this.SegmentDeveloperKey.GetHashCode();
                if (this.GoogleDeveloperKey != null)
