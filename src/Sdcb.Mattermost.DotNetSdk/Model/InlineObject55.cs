...
namespace Sdcb.Mattermost.DotNetSdk.Model
{
    ...
    public partial class InlineObject55 :  IEquatable<InlineObject55>, IValidatableObject
    {
        ...
        public InlineObject55(string name = default(string), string description = default(string), string iconUrl = default(string), List<string> callbackUrls = default(List<string>), string homepage = default(string), bool isTrusted = default(bool))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for InlineObject55 and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (description == null)
            {
                throw new InvalidDataException("description is a required property for InlineObject55 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("callbackUrls is a required property for InlineObject55 and cannot be null");
            }
            else
            {
            ...
            if (homepage == null)
            {
                throw new InvalidDataException("homepage is a required property for InlineObject55 and cannot be null");
            }
            else
            {
