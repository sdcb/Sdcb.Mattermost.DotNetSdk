...
namespace Sdcb.Mattermost.DotNetSdk.Model
{
    ...
    public partial class InlineResponse2003 :  IEquatable<InlineResponse2003>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="followLink">The link for the user to follow to login or to complete the account switching when the current service is OAuth2/SAML.</param>
        public InlineResponse2003(string followLink = default(string))
        {
        ...
        /// </summary>
        /// <value>The link for the user to follow to login or to complete the account switching when the current service is OAuth2/SAML</value>
        [DataMember(Name="follow_link", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FollowLink: ").Append(FollowLink).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(InlineResponse2003 input)
        {
            ...
            return 
                (
                    this.FollowLink == input.FollowLink ||
                    (this.FollowLink != null &&
                    this.FollowLink.Equals(input.FollowLink))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FollowLink != null)
                    hashCode = hashCode * 59 + this.FollowLink.GetHashCode();
                return hashCode;
            }
        }
