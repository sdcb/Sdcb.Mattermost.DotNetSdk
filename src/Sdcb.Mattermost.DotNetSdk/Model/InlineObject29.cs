...
namespace Sdcb.Mattermost.DotNetSdk.Model
{
    ...
    public partial class InlineObject29 :  IEquatable<InlineObject29>, IValidatableObject
    {
        ...
        public InlineObject29(bool schemeAdmin = default(bool), bool schemeUser = default(bool))
        {
            // to ensure "schemeAdmin" is required (not null)
            if (schemeAdmin == null)
            {
                throw new InvalidDataException("schemeAdmin is a required property for InlineObject29 and cannot be null");
            }
            else
            {
            ...
            if (schemeUser == null)
            {
                throw new InvalidDataException("schemeUser is a required property for InlineObject29 and cannot be null");
            }
            else
            {
