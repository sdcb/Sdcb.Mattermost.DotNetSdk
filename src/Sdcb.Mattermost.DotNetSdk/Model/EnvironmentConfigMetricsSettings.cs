...
namespace Sdcb.Mattermost.DotNetSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EnvironmentConfigMetricsSettings :  IEquatable<EnvironmentConfigMetricsSettings>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnvironmentConfigMetricsSettings" /> class.
        /// </summary>
        /// <param name="enable">enable.</param>
        /// <param name="blockProfileRate">blockProfileRate.</param>
        /// <param name="listenAddress">listenAddress.</param>
        public EnvironmentConfigMetricsSettings(bool enable = default(bool), bool blockProfileRate = default(bool), bool listenAddress = default(bool))
        {
            this.Enable = enable;
        ...
        {
            return this.Equals(input as EnvironmentConfigMetricsSettings);
        }

        /// <summary>
        /// Returns true if EnvironmentConfigMetricsSettings instances are equal
        /// </summary>
        /// <param name="input">Instance of EnvironmentConfigMetricsSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnvironmentConfigMetricsSettings input)
        {
            if (input == null)
                return false;
